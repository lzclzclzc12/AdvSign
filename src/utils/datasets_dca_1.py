...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, faces, texture_size, vertices, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.mask_renderer1 = nmr.NeuralRenderer(img_size=img_size).to(self.device)
    ...
    def __getitem__(self, index):
        ...
        eye1, camera_direction1, camera_up1 = nmr.get_params(cam_trans1, veh_trans)
        ...
        # imgs_pred3 = self.mask_renderer1.forward(self.vertices_var, self.faces_var, self.textures
