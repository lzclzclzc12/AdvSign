...
parser.add_argument("--textures", type=str, default='D:/PyCharmProject/DualAttentionAttack-main/src/textures/smile_trained.npy')
...
mask_dir = 'E:/BaiduNetdiskDownload/DualAttentionAttack/masks/'
obj_file =args.obj
texture_size = 6
...
if __name__ == "__main__":
    ...
    net = torch.hub.load(r'D:\PyCharmProject\yolov3-master', 'custom',
